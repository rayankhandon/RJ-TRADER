...
export const Footer: React.FC = () => {
  return (
    <footer className="w-full bg-[#06182F] text-white pt-16 pb-8 border-t border-white/10 relative overflow-hidden">
      ...
      {/* Decorative Low-Opacity Background Watermark in Corner */}
      ...
      <div className="w-full max-w-[1700px] mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-10 lg:gap-12 mb-14">
          ...
          <div className="lg:col-span-2 space-y-5">
            ...
            <div className="pt-1 flex items-center gap-2.5">
              <a
                href="#"
                aria-label="Facebook"
                className="w-8 h-8 rounded-full border border-gray-700/80 hover:border-[#F97316] hover:bg-[#F97316] text-gray-300 hover:text-white flex items-center justify-center transition-all duration-200 cursor-pointer shadow-sm hover:scale-110"
              >
              ...
              <a
                ...
                rel="noreferrer"
                aria-label="WhatsApp"
                className="w-8 h-8 rounded-full border border-gray-700/80 hover:border-[#25D366] hover:bg-[#25D366] text-gray-300 hover:text-white flex items-center justify-center transition-all duration-200 cursor-pointer shadow-sm hover:scale-110"
              >
                <svg className="w-3.5 h-3.5 fill-current" viewBox="0 0 24 24">
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-3 text-xs text-gray-300 font-normal">
        ...
        <div className="pt-6 border-t border-gradient border-white/10 relative">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-between text-xs text-gray-400 gap-4">
            <div>
              © {new Date().getFullYear()} RJ Traders. All rights reserved.
            </div>
