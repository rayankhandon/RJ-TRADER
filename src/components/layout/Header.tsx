          ...
          <div className="flex items-center gap-3 lg:gap-6 shrink-0">
            ...
            <div className="relative hidden xl:block" ref={categoryRef}>
              <button
                ...
                className="flex items-center gap-2 bg-[#F5F6F8] hover:bg-gray-200/80 text-gray-900 text-xs font-bold uppercase tracking-wider px-3.5 py-2.5 rounded-md border border-gray-300 transition-colors cursor-pointer shrink-0"
              >
            ...
            <form onSubmit={handleSearchSubmit} className="relative flex items-center w-full">
              <div className="relative flex-1">
                <input
                  ...
                  className="w-full pl-4 pr-10 py-2.5 bg-[#F5F6F8] border border-gray-300 rounded-l-md text-xs sm:text-sm text-gray-900 placeholder-gray-500 focus:outline-hidden focus:ring-2 focus:ring-[#F97316] focus:bg-white transition-all"
                />
                <Search className="w-4 h-4 text-gray-400 absolute right-3 top-1/2 -translate-y-1/2 pointer-events-none" />
              </div>
              <button
                type="submit"
                className="bg-[#F97316] hover:bg-[#EA580C] text-white text-xs sm:text-sm font-bold uppercase tracking-wider px-5 py-2.5 rounded-r-md transition-colors shadow-xs hover:shadow-md cursor-pointer shrink-0"
              >
                SEARCH
              </button>
            </form>
